...
public class GetTicketHandlerTests : TestBase
{
    ...
    public async Task Handle_WhenCalled_ReturnsTicket()
    {
        ...
        var command = new GetTicketHandlerQuery
        {
    ...
    {
        // Arrange
        var query = new GetTicketHandlerQuery
        {
        ...
        var response = new EntityResponse<Ticket>
        {
            ...
            Errors = new List<string> { string.Format(ErrorMessages.EntityNotFound, typeof(Ticket), query.TicketId) }
        };
