...
public partial class AccountsController(IMediator mediator) : ControllerBase
{
    ...
    {
        var result = await mediator.Send(new CreateAccountHandlerCommand
        {
        ...
        return CreatedAtRoute(GetAccountRouteName, routeValues: new { account_id = result.Entity.AccountId}, value: result);
    }
    ...
    public async Task<IActionResult> GetAccountAsync([Required, FromRoute(Name = "account_id")] Guid account_id,
